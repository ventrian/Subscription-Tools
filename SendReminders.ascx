<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SendReminders.ascx.vb" Inherits="Ventrian.SubscriptionTools.SendReminders" %>
...
<div align="left">
	<dnn:sectionhead id="dshReminderSettings" cssclass="Head" runat="server" text="Reminder Settings"
		section="tblReminderSettings" resourcekey="ReminderSettings" includerule="True"></dnn:sectionhead>
	<TABLE id="tblReminderSettings" cellSpacing="0" cellPadding="2" width="100%" summary="Reminder Settings Details Design Table"
		border="0" runat="server">
		<TR>
			<TD colSpan="3">
				<asp:label id="lblReminderSettingsHelp" cssclass="Normal" runat="server" resourcekey="ReminderSettingsHelp"
